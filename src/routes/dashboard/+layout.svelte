...
<div class="min-h-screen bg-gray-50">
	<!-- Dashboard Header -->
	<header class="bg-white/80 backdrop-blur-lg border-b border-gray-200/50 shadow-sm">
			...
			<div class="flex justify-between h-16">
				<div class="flex items-center gap-6">
					...
					<nav class="hidden sm:flex items-center gap-1">
						<a href="/dashboard" class="px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-amber-50 rounded-lg transition-all duration-200">
							Dashboard
						</a>
						<a href="/dashboard/projects" class="px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-amber-50 rounded-lg transition-all duration-200">
							Projects
						</a>
						<a href="/dashboard/devteams" class="px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-amber-50 rounded-lg transition-all duration-200">
							Teams
						</a>
						<a href="/explore" class="px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-amber-50 rounded-lg transition-all duration-200">
							Explore
						</a>
					</nav>
				</div>
						...
						{#if showUserMenu}
							...
							>
								...
								<a href="/dashboard" class="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-amber-50 transition" role="menuitem">
									<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
										<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7m-7-7H3m14 10v7a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" />
									</svg>
									Dashboard
								</a>
